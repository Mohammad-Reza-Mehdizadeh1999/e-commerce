...
const AdminProductCard = ({ name, date, description, price, image , _id }) => {
  return (
    <Link to={`/admin/products/edit/${_id}`}>
      <div className="flex items-center  bg-[#1E293B] gap-8 text-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow">
        <div className="w-1/3">
          <img
            src={image}
            alt={name}
            className="w-[300px] h-[180px] object-cover object-center rounded-lg"
          />
        </div>
