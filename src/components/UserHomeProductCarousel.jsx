...
const UserHomeProductCarousel = ({rowItems}) => {
                  ...
                  <div className="p-4 text-right text-sm gap-2 flex flex-col">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                      <div className="flex flex-row gap-2 items-center">
                        ...
                        <p>امتیاز: {Math.round(p.rate * 100) / 100}</p>
                      </div>
                      ...
                      <div className="flex flex-row gap-2">
                        ...
                        <p>زمان به روز رسانی:{(p.updatedAt)}</p>
                      </div>
                    </div>
...
export default UserHomeProductCarousel;
